...
export default function DownloadApplication() {
    ...
    const fetchApplicationDetails = async () => {
      ...
      try {
        ...
        */
        ...
        /*
        IMPORTANT:
        response.json() is called ONLY ONCE.
        */
  ...
  */
  ...
  const getFileUrl = (file) => {
    ...
    /*
    Support different possible file structures.
    */
  ...
  */
  ...
  const getEducationRow = (qualificationName) => {
    ...
    */
    ...
    /*
    Fallback in case API returns education
  ...
  */
  ...
  const getPercentage = (data) => {
    ...
    */
    ...
    /*
    Avoid 75%% if backend already stores 75%.
    */
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Only photo and signature are used here.
  |
  |--------------------------------------------------------------------------
  */
        ...
        <div className="space-y-7 p-8">
          ...
          <section>
            ...
            <div className="border border-gray-300 p-5 text-sm leading-6 text-gray-700">
              ...
              knowledge and belief. I understand that if
              any information is found to be incorrect or
              false, my application may be rejected.
