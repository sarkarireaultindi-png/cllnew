...
export default function EnvironmentForest() {
  const environmentItems = [
    "Environment Magazine 2026",
    "Environment Magazine 2024",
    "Environment Clearance Project of CCL",
    "Six Monthly Compliance",
    "Environment Statement",
    "Publications",
    "Environment Policy",
    "WED Celebration at Areas 2026",
    "WED Celebration at CCL HQ 2026",
    "WED Celebration 2025",
    "WED Celebration 2024",
    "Nature's Voice Vol-III",
  ];
      ...
      >
        ...
        <div className="relative mx-auto max-w-[1200px] px-4 py-10 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-white drop-shadow sm:text-base">
            Environmental protection, forest conservation, environmental
            clearances and sustainability initiatives of Central
            Coalfields Limited.
          </p>
          ...
          <article className="rounded-xl bg-white p-5 shadow-sm sm:p-8">
            ...
            <div className="mb-8">
              ...
              <p className="mt-4 text-[15px] leading-7 text-gray-600 sm:text-base">
                Information relating to environmental management,
                forest conservation, environmental clearances,
                publications and environmental initiatives of CCL.
              </p>
