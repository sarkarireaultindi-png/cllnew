    ...
    const fetchQualificationDetails = async () => {
      ...
      try {
        ...
        */
        ...
        const education = educationRows.map(
          (qualification) => {
            const existing =
              savedEducation.find(
                (item) =>
        ...
        */
        ...
        console.error(
          "Fetch qualification details error:",
          error
        );

        setError(
          error.message ||
            "Unable to load qualification details."
        );
      } finally {
        setLoading(false);
      }
  ...
  */
  ...
  const handleSubmit = async (e) => {
    ...
    */
    ...
    if (
      !formData.examDetails.postPreference
    ) {
      setError(
        "Please select your post preference."
      );
    ...
    */
    ...
    if (
      ...
      setError(
        "Please select your exam centre preference."
      );
                        ...
                        >
                          ...
                          <td className="border border-gray-300 px-2 py-2">
                            ...
                            <select
                              ...
                              className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 outline-none focus:border-[#ab183d] focus:ring-1 focus:ring-[#ab183d]"
                            >
